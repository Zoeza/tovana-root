...
def report_manager(request, action):
    ...
    if action == 'create_nutrition_report':
        ...
        t2d_genotype_table = data.get('t2d_table')
        t2d_prs = data.get('t2d_prs')
        omega_3_genotype_table = data.get('omega_3_table')
        ...
        vitamin_b2_genotype_table= data.get('vitamin_b2_table')
        vitamin_b2_prs = data.get('vitamin_b2_prs')
        vitamin_b12_genotype_table = data.get('vitamin_b12_table')
        vitamin_b12_prs = data.get('vitamin_b12_prs')
        vitamin_c_genotype_table = data.get('vitamin_c_table')
